...
class Pret
{
    ...
    public function getIdUserDemandeur()
    {
        return $this->idUserDemandeur;
    }
    public function getIdUserValidateur()
    {
        return $this->idUserValidateur;
    }
    public function getIdTypePret()
    {
        return $this->idTypePret;
    }
    public function getMontantPret()
    {
        return $this->montantPret;
    }
    public function getMontantRemboursementParMois()
    {
        return $this->montantRemboursementParMois;
    }
    public function getMontantTotalRemboursement()
    {
        return $this->montantTotalRemboursement;
    }
    ...
    public function setIdUserDemandeur($idUserDemandeur)
    {
        $this->idUserDemandeur = $idUserDemandeur;
    }
    public function setIdUserValidateur($idUserValidateur)
    {
        $this->idUserValidateur = $idUserValidateur;
    }
    public function setIdTypePret($idTypePret)
    {
        $this->idTypePret = $idTypePret;
    }
    ...
    public function setMontantRemboursementParMois($montantRemboursementParMois)
    {
        $this->montantRemboursementParMois = $montantRemboursementParMois;
    }
    public function setMontantTotalRemboursement($montantTotalRemboursement)
    {
        $this->montantTotalRemboursement = $montantTotalRemboursement;
    }
    ...
    public static function getAllEncours()
    {
        try {
            $db = getDB();
            $stmt = $db->query("SELECT * FROM pret p WHERE p.id IN (SELECT id FROM vw_prets_demande)");
            $types = [];
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                $pret = new Pret(
                    $row['id'],
