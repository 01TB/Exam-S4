...
<body>
    ...
    <main class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <form id="loanTypeForm" class="card bg-[#000000] p-6 shadow-lg rounded-lg mb-8 fade-in">
            <input type="hidden" id="id" name="id">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="form-control">
                    <label class="label" for="nom">
                        <span class="label-text text-[#ffffff] font-['Playfair_Display']">Nom du type de prêt</span>
                ...
                <div class="form-control">
                    <label class="label" for="montant_min">
                        <span class="label-text text-[#ffffff] font-['Playfair_Display']">Montant minimum (€)</span>
                        <svg class="h-5 w-5 text-[#007CBA] ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="form-control">
                    <label class="label" for="montant_max">
                        <span class="label-text text-[#ffffff] font-['Playfair_Display']">Montant maximum (€)</span>
                        <svg class="h-5 w-5 text-[#007CBA] ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </label>
                ...
                <div class="form-control">
                    <label class="label" for="duree_remboursement_min">
                        <span class="label-text text-[#ffffff] font-['Playfair_Display']">Durée min (mois)</span>
                        <svg class="h-5 w-5 text-[#007CBA] ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="form-control">
                    <label class="label" for="duree_remboursement_max">
                        <span class="label-text text-[#ffffff] font-['Playfair_Display']">Durée max (mois)</span>
                        <svg class="h-5 w-5 text-[#007CBA] ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                    </label>
            ...
            <button type="button" onclick="ajouterOuModifierTypePret()" class="btn bg-[#003A70] text-[#ffffff] hover:bg-[#007CBA] flex items-center">
